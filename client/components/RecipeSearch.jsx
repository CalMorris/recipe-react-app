...
// import Background from '../../server/public/bg.png'
...
export default function RecipeSearch (props) {
  ...
  return (<>
    <div className="pt-60 px-60 ">
      ...
      <h1 className="text-center text-green-700 text-4xl" style={{ fontFamily: 'Lucida Handwriting', fontSize: '2rem', fontWeight: 'bold' }}>Lets Find The Perfect Recipe</h1>
